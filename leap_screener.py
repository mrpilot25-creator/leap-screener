...
WATCHLIST = [
    ...
    "GOOGL", "GPC", "GPN", "GRMN", "GS", "GWRE", "GWW", "HAL", "HAS", "HBAN", 
    ...
    "PGR", "PH", "PHM", "PKG", "PLD", "PLTR", "PM", "PNC", "PNW", "POOL", 
    ...
    "WBA", "WBD", "WDC", "WEC", "WELL", "WFC", "WFM", "WHR", "WM", "WMB", 
